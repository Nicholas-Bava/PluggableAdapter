...
// None of the other backend classes have any UI implementation. This class and its inner classes handle the adaptation
// between IDDefinedEntities and JavaFX UI
